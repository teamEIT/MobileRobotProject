...
// Author: Quoc
// Date: 30/09/2015
// Ref: http://www.bogotobogo.com/Algorithms/path_finding_algorithm.php
...
/// <summary>
/// The idim: Horizontal size of the squares
/// The jdim: Vertical size of the squares
/// The ndir: number of possible directions to go at any position
/// </summary>
const int IDIM = 8;
const int JDIM = 6;
const int NDIR = 4;
...
const int jDir[NDIR] = {0, 1,  0, -1};// Errors
...
/// <summary>
/// The squares: Map
/// The closedNodes: List of closed (check-out) nodes
/// The openNodes: List of open (not-yet-checked-out) nodes
/// The dirMap: Map of directions (0: East, 1: North, 2: West, 3: South) 
/// </summary>
...
public:
	...
	{
		static int rd, cd, d; // 
		rd = locDest.row - rPos; // rd = rGoal - rPos
		cd = locDest.col - cPos; // cd = cGoal - cPos
